...
#predict 
yhat = sklearn_svm.predict(X_testset)
...
##############################################  Another models evaluation: hinge function  ##########################################################
...
##############################################  Another models evaluation: confussion matrix  ##########################################################
...
plt.figure()
plot_confusion_matrix(cnf_matrix, classes=['Legal(0)','Fraudulent(1)'],normalize= False,  title='Confusion matrix')

#I can also use the f1score or the jaccard index of accuracy
print(f1_score(y_testset, yhat, average='weighted') )
print(jaccard_score(y_testset, yhat,pos_label=0))
